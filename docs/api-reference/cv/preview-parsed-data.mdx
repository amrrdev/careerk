...
<Info>
  **Skills Verification**: Skills are marked as verified during the confirm-and-save step. In
  preview, skills are shown from the parser output and may not all be verified.
</Info>
