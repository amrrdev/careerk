...
| ------ | --------------------------------- | -------------- | ---------------- |
| GET    | `/job-seekers/me/skills`          | Get all skills | Yes (Job Seeker) |
| POST   | `/job-seekers/me/skills`          | Add skills     | Yes (Job Seeker) |
| DELETE | `/job-seekers/me/skills/:skillId` | Remove skill   | Yes (Job Seeker) |
